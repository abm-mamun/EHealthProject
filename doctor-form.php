   ...
   $select_db= mysql_select_db('doctors');
   if (!$select_db) {
   ...
   if (isset($_POST['Submit'])) {
     ...
     if (!empty ($_POST["Name"]) && !empty ($_POST["Email"]) && !empty ($_POST["PhoneNumber"]) && !empty ($_POST["Speciality"]) && !empty($_POST["Address"])) {
    ...
    $query = "INSERT INTO doc_info (Name, Email, PhoneNumber, Speciality, Address) VALUES ('$Name', '$Email', '$PhoneNumber', '$Speciality', '$Address')";
...
<body>
  ...
  <div class="" id="">
      <center>
        <h1><strong>Doctor Registration</h1></strong>
      </center>
      <form action="doctor-form.php" method= "post">
        <div class="col-md-6">
          ...
          * <?php echo "$NumberError" ?><br>
          ...
          <input type="text" class="form-control" Name="Speciality" id="exampleInputNumber" placeholder="Your Track"required>
          * <?php echo "$SpecialityError" ?><br>
          </div>
